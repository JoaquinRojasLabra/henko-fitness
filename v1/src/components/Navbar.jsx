      ...
      >
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <a href="https://instagram.com/henko_fitness" target="_blank" rel="noreferrer"
            className="ml-3 px-4 py-1.5 text-sm font-semibold bg-[var(--primary)] text-[var(--primary-fg)] rounded-full transition-all duration-300 hover:brightness-110 active:scale-[0.97]">
            Únete
          </a>
        </div>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            <motion.a href="https://instagram.com/henko_fitness" target="_blank" rel="noreferrer"
              initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}
