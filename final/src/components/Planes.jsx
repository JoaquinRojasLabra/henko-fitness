...
function PlanCard({ plan, index, isAnnual }) {
  ...
  return (
    ...
    >
      ...
      <div className={`p-0.5 rounded-[1.5rem] h-full ${plan.popular ? "bg-gradient-to-b from-[var(--primary)]/40 via-[var(--primary)]/20 to-transparent" : "bg-gradient-to-b from-white/5 to-transparent"}`}>
