...
import { MapPin, Clock, InstagramLogo, WhatsappLogo } from "@phosphor-icons/react";

const contactInfo = [
  { icon: MapPin, label: "Dirección", value: "Gilda Díaz Girón 821, Paine, Región Metropolitana, Chile" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="flex gap-3 mt-8">
              ...
              <a href="https://maps.google.com/?q=Gilda+Diaz+Giron+821+Paine+Chile" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2 px-5 py-3 rounded-full bg-white/5 border border-[var(--border)] text-[var(--muted)] hover:text-[var(--fg)] transition-all duration-300 text-sm">
