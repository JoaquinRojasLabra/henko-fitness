...
const images = [
  {
    ...
    alt: "Equipo de crossfit",
    span: "md:col-span-2 md:row-span-2",
  },
  {
    src: "https://images.unsplash.com/photo-1577223625816-7546f13df25d?w=400&q=80",
    alt: "Pesas rusas",
    span: "",
  },
  {
  ...
  {
    src: "https://images.unsplash.com/photo-1599058917765-a780eda07a3e?w=400&q=80",
    alt: "Ejercicio en grupo",
    span: "",
  },
  {
...
export default function Galeria() {
  ...
  return (
    <section id="galeria" className="relative py-28 sm:py-36 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="mt-4 text-white/40 max-w-lg mx-auto">
            Esto es más que un gimnasio. Somos una familia que se esfuerza junta cada día.
          </p>
        </motion.div>
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 text-white/60 hover:text-white text-sm transition-all duration-300"
          >
